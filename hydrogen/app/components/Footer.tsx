      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-1 md:col-span-2 space-y-6">
            <div>
              <h2 className="text-2xl font-light tracking-[0.2em] uppercase mb-2">DIBI Milano</h2>
              <p className="text-xs tracking-[0.3em] text-gray-500 uppercase">Skin Center</p>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-gray-600">
              ...
              <li><Link to="/products" className="hover:text-[#D4C5B9] transition-colors">Shop Products</Link></li>
