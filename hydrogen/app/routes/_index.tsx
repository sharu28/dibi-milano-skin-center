      ...
      <section className="py-24 md:py-32 px-4 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-2xl md:text-4xl font-serif text-gray-800 leading-relaxed">
            At DIBI Milano Skin Center, we believe that healthy skin is the foundation of true
            beauty. Our expert clinicians combine advanced technology with personalized care to
            deliver transformative results.
          </p>
          <div className="mt-12">
            <a
              href="#"
              className="inline-flex items-center text-sm font-medium tracking-widest text-gray-900 hover:text-[#D4C5B9] transition-colors uppercase border-b border-gray-900 hover:border-[#D4C5B9] pb-1"
            >
      ...
      <section className="py-24 bg-[#F9F9F7]">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <h2 className="text-2xl md:text-3xl font-serif italic text-gray-800 mb-12 leading-relaxed">
            &ldquo;The most incredible facial I&rsquo;ve ever had. The team at DIBI Milano truly
            understands skin and tailors everything to your specific needs. My skin has never
            looked better!&rdquo;
          </h2>
      ...
      <section className="py-2">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-1">
          {[
            ...
            <a
              key={i}
              href="https://www.instagram.com/dibimilano_skincentre"
              target="_blank"
        ...
        <div className="text-center py-12 bg-white">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center text-sm font-medium tracking-widest text-gray-900 hover:text-[#D4C5B9] transition-colors uppercase"
          >
