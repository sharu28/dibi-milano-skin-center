...
export const meta: Route.MetaFunction = () => {
  return [
    {title: 'Careers | DIBI Milano Skin Center'},
    {
      name: 'description',
      content:
      ...
      <section className="py-24 px-4 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl md:text-3xl font-serif text-gray-800 leading-relaxed">
            At DIBI Milano Skin Center, we are passionate about transforming lives through skin
            health. We are always looking for dedicated, talented professionals who share our
            commitment to excellence, continuous learning, and providing an unparalleled client
            experience.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            <div className="bg-white p-8 border border-gray-100 hover:border-[#D4C5B9] transition-colors group">
              <div className="flex flex-col md:flex-row md:items-center justify-between">
                ...
                <a
                  href="mailto:careers@dibimilano.com?subject=Application for Senior Aesthetician"
                  className="inline-flex items-center text-xs font-semibold tracking-[0.2em] text-gray-900 uppercase hover:text-[#D4C5B9] transition-colors"
                >
                  Apply Now <ArrowRight className="ml-2 w-4 h-4" />
                </a>
              </div>
              <p className="text-gray-600 font-serif mt-4 leading-relaxed">
                Seeking an experienced aesthetician with a deep understanding of advanced skin
                treatments, chemical peels, and laser therapies. Minimum 3 years of clinical
                experience required.
              </p>
            </div>
            ...
            <div className="bg-white p-8 border border-gray-100 hover:border-[#D4C5B9] transition-colors group">
              <div className="flex flex-col md:flex-row md:items-center justify-between">
                ...
                <a
                  href="mailto:careers@dibimilano.com?subject=Application for Front Desk Coordinator"
                  className="inline-flex items-center text-xs font-semibold tracking-[0.2em] text-gray-900 uppercase hover:text-[#D4C5B9] transition-colors"
                >
                  Apply Now <ArrowRight className="ml-2 w-4 h-4" />
                </a>
              ...
              <p className="text-gray-600 font-serif mt-4 leading-relaxed">
                The first point of contact for our clients. We are looking for a highly organized,
                impeccably presented individual with excellent communication skills and a passion
          ...
          <div className="mt-20 text-center bg-white p-12 border border-gray-100">
            ...
            <p className="text-lg font-serif text-gray-600 mb-8 max-w-2xl mx-auto">
              We are always open to meeting exceptional talent. Send us your CV and a cover letter
              detailing how you can contribute to the DIBI Milano team.
            </p>
            <a
