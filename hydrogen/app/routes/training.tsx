...
export const meta: Route.MetaFunction = () => {
  return [
    {title: 'Training | DIBI Milano Skin Center'},
    {
      name: 'description',
      content:
        'Professional training in advanced skin science and aesthetics at the DIBI Milano Academy.',
    },
  ];
};
    ...
    <div className="min-h-screen bg-[#F9F9F7]">
      ...
      <section className="py-32 bg-white text-center px-4">
        ...
        <p className="text-lg font-serif text-gray-600 mb-10 max-w-2xl mx-auto">
          Reserve your place in an upcoming intake, or message us to find the course that&rsquo;s
          right for you.
        </p>
        <a
